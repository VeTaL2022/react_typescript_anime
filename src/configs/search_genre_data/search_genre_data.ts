...
const search_genre_items: IGenre[] = [
    {
        "mal_id": 1,
        "name": "Action",
...
const search_themes_items: IGenre[] = [
    {
        "mal_id": 50,
        "name": "Adult Cast",
...
const search_demographics_items: IGenre[] = [
    {
        "mal_id": 43,
        "name": "Josei",
...
export {search_genre_items, search_themes_items, search_demographics_items};
